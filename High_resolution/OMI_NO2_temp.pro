...
; Set up directories
  ...
  OutDir = '/home/liufei/Data/Large_point/Regrid/results/Beijing/'  ; note: end with '/'

; Set up date to process
  STDATE = 200501    ; start date: YYYYMM
  EDDATE = 200712    ;   end date: YYYYMM
...
;  L_Month = 'N'
  ...
  Month_st = 2       ; Start month for annual mean calculation
  Month_ed = 10       ; end month for annual mean calculation
...
if(L_Year eq 'Y') then begin
  ...
  if(Month eq Month_ed) and (Year eq Fix(EDDATE/100)) then begin
