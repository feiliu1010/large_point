...
;Chongqing
;pp_loc_lon=[106.550827]
;pp_loc_lat=[29.567286]
;Chengdu
pp_loc_lon=[104.062347]
pp_loc_lat=[30.665872]
;P2
;pp_loc_lon=[121.6]
;pp_loc_lat=[31.3528]
;shanghai
...
print,'x_axle1',x_axle1
print,'LD1',LD1
print,'x_axle9',x_axle9
print,'LD9',LD9
